                    ...
                    <?php if (get_field('donor_form')) { ?>
                        <a class="donate-button"
                           ...
                           target="_blank" download="RemedyCircleMembers">
                            View Remedy Circle Members <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/download_icon.png" />
                        </a>
                    <?php } ?>
                    ...
                    <?php if( have_rows('downloadable_items') ):
                            ...
                            while ( have_rows('downloadable_items') ) : the_row();
                                ...
                                <a class="donate-button"
                                   ...
                                   target="_blank" download="RemedyCircleMembers">
                                    <?php the_sub_field('link_title') ?> <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/download_icon.png" />
                                </a>
                ...
                <?php if (get_field('show_paypal')) { ?>
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                        ...
                        <button
                            ...
                            Donate via <img
                                src="<?php echo get_stylesheet_directory_uri(); ?>/img/button-icons/paypal_icon.png"
                                title="Paypal"
                            />
                        </button>
                    </form>
