...
<head>
    ...
    <script type="text/javascript">stLight.options({
            onhover: false,
            publisher: "d77d5a6e-b82d-47c6-a7df-dbb732c20b77",
            doNotHash: false,
            doNotCopy: false,
...
<header>
    <div class="header_top_wrap">
        <div class="header_top container">
            <div class="pull-right social_media_links">
                <a target="_blank" href="https://www.facebook.com/campsouthernground"
                   class="social_media_link facebook"></a>
                <a target="_blank" href="https://www.instagram.com/campsouthernground/"
                   class="social_media_link instagram"></a>
                <a target="_blank" href="https://twitter.com/campsoutherngrd" class="social_media_link twitter"></a>
                <a target="_blank" href="https://www.youtube.com/user/CampSouthernGround"
                   class="social_media_link youtube"></a>
            </div>
        </div>
    </div>
    ...
    <div class="header_nav_wrap">
        <div id="hamburger"
             style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/img/hamburger.png')"></div>
